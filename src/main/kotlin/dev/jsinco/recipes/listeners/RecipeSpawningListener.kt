...
class RecipeSpawningListener : Listener {
    ...
    fun onLootGenerate(event: LootGenerateEvent) {
        for (spawnConfig in Recipes.spawnConfig.recipeSpawning) {
            ...
            if (spawnConfig is LootSpawnTrigger) {
